...
# #     for i in range(2):
# #         images_data.append(
# #             {"Image_Path": "path1", "Location": "Zone 3", "Date": "01-01-2025", "Time": "12:00:00",
...
#     lb_per = data["data"]["EB_per"]
#     eb_per = data["data"]["LB_per"]
...
#     assert abs(mod_rate - expected_mod_rate) < 1e-1
#     assert lb_per == expected_LB
#     assert eb_per == expected_EB

#     filter_query = {"Date": "01-01-2025"}
